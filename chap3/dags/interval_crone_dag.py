...
with DAG(
    ...
    # process data for the specified interval [start_date, end_date)
    # we can process data for missing dates with catchup=True
    ...
    # use logical date since we want to only calculate statistic
    # for current json file we just fetch
